        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            http
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/appointments/create/**", "/appointments/update/**", "/appointments/delete/**")
                        ...
                        .requestMatchers("/patients/create/**", "/patients/update/**", "/patients/delete/**")
                        .hasAuthority(PrivilegeType.WRITE_PATIENT.name())
                        .requestMatchers("/patients")
                        .hasAuthority(PrivilegeType.READ_ALL_PATIENTS.name())
                        .requestMatchers("/physicians/create/**", "/physicians/update/**", "/physicians/delete/**")
                        ...
                        .requestMatchers("/diagnosis/create/**", "/diagnosis/update/**", "/diagnosis/delete/**")
                        ...
                        .requestMatchers("/sick-leaves/create/**", "/sick-leaves/update/**", "/sick-leaves/delete/**")
